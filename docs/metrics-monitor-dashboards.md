...
!!! seealso "See also"
    ...
    - [Grafana Image Rendering](https://grafana.com/docs/grafana/latest/administration/image_rendering)
    - [Percona Monitoring and Management Jira Issue PMM-5735](https://jira.percona.com/browse/PMM-5735)
