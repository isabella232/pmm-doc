...
[Verify that PMM Server is running](verify.md) by connecting to the PMM web interface using the IP address assigned to the virtual appliance, then [install PMM Client](../client/) on all database hosts that you want to monitor.
